    ...
    () => [
      {
        ...
        header: "Type",
        Cell: ({ cell }) => {
          return cell.getValue() ? "Income" : "Expense";
        },
      },
      {
        accessorKey: "text",
    ...
    <MainTemplate>
      ...
      <Flex direction={"column"} gap={5}>
        ...
        <Stack
          ...
          alignItems={"center"}
        >
          <Stat  className="stathandle"
            boxShadow={"lg"}
            borderRadius={5} p={2}bg={useColorModeValue("green.50", "green.300")}
            _hover={{
              transform: "translateY(-2px)",
              boxShadow: "lg",
            }}>
            <Flex flex={"row"}>
              <RxArrowBottomLeft className="icon" />
              Income
            </Flex>
            <StatNumber color={useColorModeValue("green", "white.400")}>
          ...
          <Stat    className="stathandle"
            ...
            <StatNumber  color={useColorModeValue("red", "white.400")}>
              {" "}
              {new Intl.NumberFormat("en-IN", {
                style: "currency",
                currency: "INR",
